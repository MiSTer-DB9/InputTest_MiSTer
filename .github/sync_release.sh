...
UPSTREAM_REPO="https://github.com/MiSTer-devel/InputTest_MiSTer.git"
CORE_NAME=(InputTest)
...
UPSTREAM_CORE_NAME=(InputTest)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(InputTest.qpf)
COMPILATION_OUTPUT=(output_files/InputTest.rbf)
